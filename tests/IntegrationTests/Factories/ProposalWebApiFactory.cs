...
using ProposalWebApi;

namespace IntegrationTests.Factories;

public class ProposalWebApiFactory : WebApplicationFactory<Program>
{
    private readonly string _postgresConnectionString;
    private readonly string _rabbitMqConnectionString;

    public ProposalWebApiFactory(string postgresConnectionString, string rabbitMqConnectionString)
    {
