...
public class CustomerWebApiFactory : WebApplicationFactory<Program>
{
    private readonly string _postgresConnectionString;
    private readonly string _rabbitMqConnectionString;

    public CustomerWebApiFactory(string postgresConnectionString, string rabbitMqConnectionString)
    {
